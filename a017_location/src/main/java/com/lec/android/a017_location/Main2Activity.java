...
public class Main2Activity extends AppCompatActivity {
    ...
    class MyListener implements LocationListener{
        ...
        public void onLocationChanged(Location location) {
            Log.d("myapp", "onProviderEnabled, location: " + location);
            // location 은 toString 값으로 ..
        ...
        switch (requestCode) {
            case REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(getApplicationContext(), "위치권한획득", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(getApplicationContext(), "위치권한획득실패패", Toast.LENGTH_LONG).show();
                }
        }
