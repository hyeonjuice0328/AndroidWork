...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { //클릭되었을때 호출되는 메소드 (콜백 메소드 : 지금 당장은 아니지만 사용될때 사용하고 다시 제자리에..)
        ...
        btn2.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                return true; // false 리턴하면 이벤트가 click까지 간다.
        ...
        class MyListener implements View.OnClickListener{
            ...
            public void onClick(View v) {
                String tag = (String)v.getTag();//오브젝트 리던이라서 반드시 형변환
                String text = (String)((Button)v).getText(); // 다형성의 어려움 ppt //  getText() 는 CharSequence 객체 리턴
